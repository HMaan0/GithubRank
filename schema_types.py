...
schema_types = sgqlc.types.Schema()


# Unexport Node/PageInfo, let schema re-declare them
schema_types -= sgqlc.types.relay.Node
schema_types -= sgqlc.types.relay.PageInfo
...
class MergeStateStatus(sgqlc.types.Enum):
    __schema__ = schema_types
    __choices__ = ('BEHIND', 'BLOCKED', 'CLEAN', 'DIRTY', 'DRAFT', 'HAS_HOOKS', 'UNKNOWN', 'UNSTABLE')
...
class AnnouncementBannerI(sgqlc.types.Interface):
    __schema__ = schema_types
    __field_names__ = ('announcement', 'announcement_created_at', 'announcement_expires_at', 'announcement_user_dismissible')
    announcement = sgqlc.types.Field(String, graphql_name='announcement')
    announcement_created_at = sgqlc.types.Field(DateTime, graphql_name='announcementCreatedAt')
...
class DependencyGraphDependency(sgqlc.types.Type):
    __schema__ = schema_types
    __field_names__ = ('has_dependencies', 'package_label', 'package_manager', 'package_name', 'repository', 'requirements')
    has_dependencies = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='hasDependencies')
    package_label = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='packageLabel')
...
class Enterprise(sgqlc.types.Type, AnnouncementBannerI, Node):
    __schema__ = schema_types
    __field_names__ = ('announcement_banner', 'avatar_url', 'billing_email', 'billing_info', 'created_at', 'database_id', 'description', 'description_html', 'location', 'members', 'name', 'organizations', 'owner_info', 'readme', 'readme_html', 'resource_path', 'ruleset', 'rulesets', 'slug', 'url', 'viewer_is_admin', 'website_url')
...
class Issue(sgqlc.types.Type, Assignable, Closable, Comment, Deletable, Labelable, Lockable, Node, ProjectV2Owner, Reactable, RepositoryNode, Subscribable, SubscribableThread, UniformResourceLocatable, Updatable, UpdatableComment):
    __schema__ = schema_types
    __field_names__ = ('body_resource_path', 'body_url', 'closed_by_pull_requests_references', 'comments', 'full_database_id', 'hovercard', 'is_pinned', 'is_read_by_viewer', 'linked_branches', 'milestone', 'number', 'parent', 'participants', 'project_cards', 'project_items', 'state', 'state_reason', 'sub_issues', 'sub_issues_summary', 'timeline', 'timeline_items', 'title', 'title_html', 'tracked_in_issues', 'tracked_issues', 'tracked_issues_count')
...
class OrganizationInvitation(sgqlc.types.Type, Node):
    __schema__ = schema_types
    __field_names__ = ('created_at', 'email', 'invitation_source', 'invitation_type', 'invitee', 'inviter', 'inviter_actor', 'organization', 'role')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    email = sgqlc.types.Field(String, graphql_name='email')
...
class ProjectV2(sgqlc.types.Type, Closable, Node, Updatable):
    __schema__ = schema_types
    __field_names__ = ('created_at', 'creator', 'database_id', 'field', 'fields', 'full_database_id', 'items', 'number', 'owner', 'public', 'readme', 'repositories', 'resource_path', 'short_description', 'status_updates', 'teams', 'template', 'title', 'updated_at', 'url', 'view', 'views', 'workflow', 'workflows')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    creator = sgqlc.types.Field(Actor, graphql_name='creator')
    database_id = sgqlc.types.Field(Int, graphql_name='databaseId')
...
class ProjectV2Item(sgqlc.types.Type, Node):
    __schema__ = schema_types
    __field_names__ = ('content', 'created_at', 'creator', 'database_id', 'field_value_by_name', 'field_values', 'full_database_id', 'is_archived', 'project', 'type', 'updated_at')
...
class ProjectV2StatusUpdate(sgqlc.types.Type, Node):
    __schema__ = schema_types
    __field_names__ = ('body', 'body_html', 'created_at', 'creator', 'database_id', 'full_database_id', 'project', 'start_date', 'status', 'target_date', 'updated_at')
    body = sgqlc.types.Field(String, graphql_name='body')
...
class ProjectV2View(sgqlc.types.Type, Node):
    __schema__ = schema_types
    __field_names__ = ('created_at', 'database_id', 'fields', 'filter', 'full_database_id', 'group_by', 'group_by_fields', 'layout', 'name', 'number', 'project', 'sort_by', 'sort_by_fields', 'updated_at', 'vertical_group_by', 'vertical_group_by_fields', 'visible_fields')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    database_id = sgqlc.types.Field(Int, graphql_name='databaseId')
    ...
    full_database_id = sgqlc.types.Field(BigInt, graphql_name='fullDatabaseId')
    group_by = sgqlc.types.Field(ProjectV2FieldConnection, graphql_name='groupBy', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
    ...
    number = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name='number')
    project = sgqlc.types.Field(sgqlc.types.non_null(ProjectV2), graphql_name='project')
    sort_by = sgqlc.types.Field(ProjectV2SortByConnection, graphql_name='sortBy', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
    ...
    updated_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='updatedAt')
    vertical_group_by = sgqlc.types.Field(ProjectV2FieldConnection, graphql_name='verticalGroupBy', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
    ...
    visible_fields = sgqlc.types.Field(ProjectV2FieldConnection, graphql_name='visibleFields', args=sgqlc.types.ArgDict((
        ('after', sgqlc.types.Arg(String, graphql_name='after', default=None)),
        ('before', sgqlc.types.Arg(String, graphql_name='before', default=None)),
        ('first', sgqlc.types.Arg(Int, graphql_name='first', default=None)),
        ('last', sgqlc.types.Arg(Int, graphql_name='last', default=None)),
...
class ProjectV2Workflow(sgqlc.types.Type, Node):
    __schema__ = schema_types
    __field_names__ = ('created_at', 'database_id', 'enabled', 'full_database_id', 'name', 'number', 'project', 'updated_at')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    database_id = sgqlc.types.Field(Int, graphql_name='databaseId')
    enabled = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='enabled')
    full_database_id = sgqlc.types.Field(BigInt, graphql_name='fullDatabaseId')
...
class PullRequestReviewComment(sgqlc.types.Type, Comment, Deletable, Minimizable, Node, Reactable, RepositoryNode, Updatable, UpdatableComment):
    __schema__ = schema_types
    __field_names__ = ('commit', 'diff_hunk', 'drafted_at', 'full_database_id', 'line', 'original_commit', 'original_line', 'original_position', 'original_start_line', 'outdated', 'path', 'position', 'pull_request', 'pull_request_review', 'reply_to', 'resource_path', 'start_line', 'state', 'subject_type', 'url')
    commit = sgqlc.types.Field(Commit, graphql_name='commit')
...
class SecurityAdvisory(sgqlc.types.Type, Node):
    __schema__ = schema_types
    __field_names__ = ('classification', 'cvss', 'cwes', 'database_id', 'description', 'epss', 'ghsa_id', 'identifiers', 'notifications_permalink', 'origin', 'permalink', 'published_at', 'references', 'severity', 'summary', 'updated_at', 'vulnerabilities', 'withdrawn_at')
...
class Sponsorship(sgqlc.types.Type, Node):
    __schema__ = schema_types
    __field_names__ = ('created_at', 'is_active', 'is_one_time_payment', 'is_sponsor_opted_into_email', 'maintainer', 'payment_source', 'privacy_level', 'sponsor', 'sponsor_entity', 'sponsorable', 'tier', 'tier_selected_at')
    created_at = sgqlc.types.Field(sgqlc.types.non_null(DateTime), graphql_name='createdAt')
    is_active = sgqlc.types.Field(sgqlc.types.non_null(Boolean), graphql_name='isActive')
...
# Schema Entry Points
########################################################################
schema_types.query_type = Query
schema_types.mutation_type = Mutation
schema_types.subscription_type = None
